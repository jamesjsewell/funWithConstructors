...
// -- ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ - Your Answer - ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ -- //
function Cat(){
	this.greet = function(){return 'meow'}
}
...
// -- ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ - Your Answer - ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ -- //
function Student(areaOfExpertise){
	this.expertise = areaOfExpertise
	this.knowledge = 0

}

Student.prototype.learn = function(moreKnowledge){
	this.knowledge += moreKnowledge
}
...
//var aKey = new Key()
function Safe(secret, aKey){
	this.key = aKey
	this.secret = secret
}
Safe.prototype.unlock = function(aKeyInstance){
	if(aKeyInstance === Safe.key){
		return Safe.secret
	}
	else{
		return null
